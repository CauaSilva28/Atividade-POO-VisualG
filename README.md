...
Demos o valor um valor para "i" que foi igual a 1. Depois usamos a função enquanto para fazer a conta, e enquanto o "i<=10" ele faria o número escolhido "*i". No final teriamos a tabuada sobre qualquer número escolhido pelo usuário.
## Tabuada com "para"
